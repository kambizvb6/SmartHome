...
struct SmartAirConditioner: View {
    ...
    var body: some View {
        Rectangle()
            ...
            .background(
                LinearGradient(
                    stops: [
                        Gradient.Stop(color: Color(smartDevice ? .smartAirCondionerEnd : Color(uiColor: .white)), location: 0.00),
                        Gradient.Stop(color: Color(smartDevice ? .smartAirCondionerStart : Color(uiColor: .white)), location: 1.00),
                    ],
            ...
            .overlay {
                VStack(alignment: .leading){
                    ...
                    Image(smartDevice ? "SmartAirr" : "SmartAirrDark")
                        .resizable()
                        .scaledToFit()
