    ...
    var body: some View {
        Rectangle()
            ...
            .background(
                LinearGradient(
                    stops: [
                        Gradient.Stop(color: Color(smartDevice ? .smartTVStart : Color(uiColor: .white)), location: 0.00),
                        Gradient.Stop(color: Color(smartDevice ? .smartTVEnd : Color(uiColor: .white)), location: 1.00),
                    ],
            ...
            .overlay {
                VStack(alignment: .leading){
                    ...
                    Image(smartDevice ? "SmartTV" : "SmartTVDark")
                        .resizable()
                        .scaledToFit()
